...
function movieInfo(id) {
    $.getJSON(movieCast + id + "/casts?" + key, function (json) {
        ...
        $.getJSON(infoURL, function (data) {
            ...
            $('.content').css({"background-image": "url(" + backdrop + ")","background-repeat": "no-repeat","background-size": "cover",    "opacity": "0.9"});
            ...
            $(".item-container").prepend(
                ...
                "<br/>" +
                "<img " +
                "<div class='movie-tags'><span class='movie-taxonomy'>" +
                genre +
